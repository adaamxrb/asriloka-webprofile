const servicesData = [
    ...
    },
    {
        ...
        description: ['Fasilitator yang kompeten, menjadikan outbound sangat menyenangkan, memberikan output pesertanya seperti yang di harapkan di sebuah organisasi ataupun perusahaan, pastinya memberikan pengalaman yang tidak terlupakan, sehingga terstruktur dan terencana dengan baik.']
    },
    {
        title: "Smart & Fun",
        category: "smart&fun",
        description: ['Permainan disajikan dengan pendekatan cerdas dan menyenangkan. Setiap permainan tidak hanya berfokus pada hiburan semata, tetapi juga mengedepankan unsur-unsur koordinasi, kepemimpinan, dan kerja sama tim dalam setiap tahap pelaksanaannya. Fasilitator yang cerdas akan membimbing melalui pengalaman bermain yang tidak hanya mengasyikkan, tetapi juga memberikan kesempatan untuk memperkuat keterampilan koordinasi, kepemimpinan, dan kerja tim secara interaktif.']
    },
    {
...
const programsData = [
    ...
    },
    {
        ...
        description: ['-  Api unggun', '-  Jurit malam', '-  BBQ (bakar-bakar)', '-  Terapi ikan', '-  Karaoke', '-  Sports area', '-  Flying fox', '-  Petik buah', '-  Jelajah alam', '-  Susur sungai', '-  Bermain di sungai', '-  Berbagai spot foto', '-  dll']
    }
]